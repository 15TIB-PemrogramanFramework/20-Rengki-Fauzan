        ...
        <a href="<?php echo site_url('obat/tambah_1');?>" class="btn btn-primary" style="margin-top:20px;margin-bottom:20px"><i class="fa fa-plus-square"> Tambahkan Stok</i></a>
                    ...
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h1>Data Stok Obat di Puskesmas Pembantu 7</h1>
                        </div>
                        <!-- /.panel-heading -->
                       ...
                       <td>
                <a href="<?php echo site_url('obat/delete_7/'.$value->id_stok);?>" class="btn btn-danger">
                    <i class="fa fa-trash"></i>
                </a>
                <a href="<?php echo site_url('obat/update_7/'.$value->id_stok);?>" class="btn btn-warning">
